...
/opt/IBM/WebSphere/AppServer9057/bin/wsadmin.sh -f /home/ibmuser/WAS-Automation-LabFiles/lab2-MemoryLeak/klp-setMaxHeapAndJVMarg.py

echo ""
echo "Install the Memory leak application (MLAPP) in WebSphere"
echo ""
/opt/IBM/WebSphere/AppServer9057/bin/wsadmin.sh -f /home/ibmuser/WAS-Automation-LabFiles/lab2-MemoryLeak/klp-install_MLApp.py
