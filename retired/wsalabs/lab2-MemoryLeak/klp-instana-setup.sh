...
echo "" 
echo "scp /home/ibmuser/WAS-Automation-LabFiles/wsalabs/lab2-MemoryLeak/klp-updateInstana.sh ibmadmin@instana:/home/ibmadmin/klp-updateInstana.sh"
echo ""
echo "-----------------------------------------------------------------------"
echo "" 

sshpass -p "passw0rd" scp /home/ibmuser/WAS-Automation-LabFiles/wsalabs/lab2-MemoryLeak/klp-updateInstana.sh ibmadmin@instana:/home/ibmadmin/klp-updateInstana.sh
